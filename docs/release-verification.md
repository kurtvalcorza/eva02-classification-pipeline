...
|---|---|---|---|---|---|
| 2026-09-14 | `78f7f7c` / `3f9b46469ce8` | Kaggle T4 (`kurtvalcorza/dimer-nb2-eva02-classification` v1) | Default sample path | 209.4 s | **PASSED** — 10/10 ok code cells executed cleanly, 8 files, 348 MB staged |
