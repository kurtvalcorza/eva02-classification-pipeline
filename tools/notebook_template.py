    ...
    "cells": [
        ...
        },
        {
            "md": (
                ...
                "the evaluation report, the fine-tuning training history, the sample identity, aspect ratio and digest, the notebook's "
                ...
                "so class ordering survives downstream use. Deployable fine-tuned model artifacts are published in "
                "`outputs/{stem}_finetuned/`. No credentials are recorded."
            ),
            "code": (
                "import csv\n\n"
                "payload = {{\n"
