...
EXPECTED_MODEL_ID = "timm/eva02_base_patch14_448.mim_in22k_ft_in22k_in1k"
...
EXPECTED_OUTPUTS = (
    'outputs/eva02_classification_result.json',
    'outputs/eva02_classification_top_k.csv',
)
...
CODE_MARKERS = (
    ...
    'from eva02_classification_pipeline import MODEL_ID, MODEL_KEY, MODEL_REVISION, '
    'EVA02ClassificationPipeline, stage_missing_files, top_k_accuracy, verify_snapshot',
...
MARKDOWN_MARKERS = (
    ...
    '**squash-resizes every input to a fixed 448 x 448**',
    ...
    'It is computed only when a ground-truth class index was supplied',
