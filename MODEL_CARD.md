...
- Measured (WSL venv, RTX 5070 Ti 16 GB, `HF_HUB_OFFLINE=1`): device `cuda:0`, source `local-snapshot`, load 6.42 s, predict 0.81 s, total 7.23 s, top-1 on a synthetic 256×256 gradient image `screen, CRT screen` (index 782) at score 0.0127. CPU not measured.
